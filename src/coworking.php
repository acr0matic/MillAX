          ...
          <div class="row">
            <div class="col-12 col-lg-4 mb-3 mb-lg-0" data-aos="fade-up" data-aos-offset="150">
              <div class="included__card">
                <div class="included__wrapper">
                  ...
                  <ul class="included__list list list--unmarked">
                    <li class="list__item">
                      Индивидуально рабочее место (стол, игровое кресло, сканер, профессональный компьютер)
                    </li>

                    <li class="list__item">
                      Предустановленное программное обеспечение (программа для 3D моделирования на выбор, Rhinoceros 3D)
                    </li>

                    <li class="list__item">
                      Сканбоди с библиотеками от GEO и другие
                    </li>

                    <li class="list__item">
                      Льготный прайс фрезерных услуг
                    </li>

                    <li class="list__item">
                      Оснащенный кабинет для обработки
                    </li>

                    <li class="list__item">
                      Обеденная зона, зона отдыха, бесплатные бодрящие напитки (чай, кофе), питьевая вода
                    </li>
                  </ul>
                </div>
                <!-- /.included__wrapper -->
            ...
            <div class="col-12 col-lg-4 mb-3 mb-lg-0" data-aos="fade-up" data-aos-offset="150">
              <div class="included__card">
                <div class="included__wrapper">
                  ...
                  <ul class="included__list list list--unmarked">
                    <li class="list__item">
                      Услуги администратора (маршрутные листы,
                      контроль этапов производства
                      и информирование,
                      прием входящих работ, оформление заказ-нарядов
                      для производственных
                      отделов и т.д.)
                    </li>

                    <li class="list__item">
                      Бухгалтерское сопровождение (общие консультации, подготовка закрывающих документов, выставление счетов, составление
                    ...
                    <li class="list__item">
                      Юридическая поддержка (общие консультации)
                    </li>
                    ...
                    <li class="list__item">
                      Услуги по поиску и заказу расходных материалов
                    </li>
                  </ul>
                </div>
                <!-- /.inculed_wrapper -->
            ...
            <div class="col-12 col-lg-4 mb-3 mb-lg-0" data-aos="fade-up" data-aos-offset="150">
              <div class="included__card">
                <div class="included__wrapper">
                  <h3 class="included__title">
                    Менторство и трекинг
                  </h3>

                  <ul class="included__list list list--unmarked">
                    <li class="list__item">
                      Услуги по продвижению
                      и построению индивидуальной траектории развития бизнеса
                      для техника-оператора CAD/CAM
                    </li>

                    <li class="list__item">
                      Менторство: индивидуальные консультации
                    </li>

                    <li class="list__item">
                      Менторство: экспертные сессии
                    </li>
    ...
    <section id="subscription" class="section">
      ...
      <div class="subscription__container container">
        <div class="section__heading">
          <h2 class="section__title">Станьте резидентом коворкинга прямо сейчас!</h2>
          <h3 class="section__subtitle">Приобретите выгодный для вас абонимент</h3>
        </div>
        <!-- /.section__heading -->
