        ...
        <div class="not-found">
          ...
          <div class="not-found__wrapper">
            <div class="not-found__error">
              <span class="not-found__notice">Ой!</span>
              <span class="not-found__code">404</span>
            </div>
            <!-- /.404__error -->
            <h1 class="not-found__title">Эта страничка еще в разработке или ее не существует ;)</h1>

            <button class="not-found__button button button-outline">Вернуться на главную</button>
          </div>
          <!-- /.not-found__wrapper -->

          <img class="not-found__image" src="img/pictures/404/notebook.svg" alt="">
        </div>
        <!-- /.404 -->
      </div>
      <!-- /.container -->
