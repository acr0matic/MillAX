      ...
      <div class="container">
        <div class="header">
          ...
          <div class="header__action">
            ...
            <button data-micromodal-trigger="modal-courier" class="header__button button button-small">Вызвать курьера</button>
          </div>
          <!-- /.header__action -->
        </div>
        <!-- /.header -->
